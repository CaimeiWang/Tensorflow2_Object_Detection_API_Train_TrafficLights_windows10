...
flags.DEFINE_string(
    'model_dir', 'TL_training', 'Path to output model directory '
    'where event and checkpoint files will be written.')
flags.DEFINE_string('pipeline_config_path', 'TL_training/faster_rcnn_inception_v2_pets.config', 'Path to pipeline config '
                    'file.')
