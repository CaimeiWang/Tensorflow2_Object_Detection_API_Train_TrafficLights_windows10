...
labels = ['Traffic_Light_go', 'Traffic_Light_stop', 'Traffic_Light_ambiguous',
          'Traffic_Light_warning']  # label for datasets

cnt = 0
txt_path = os.path.join(r"D:\pycharm_community\tensorflow_object_detection_API\models-master\research\object_detection\traffic_lights\labels/")  # 存放txt的文件目录
image_path = os.path.join(r"D:\pycharm_community\tensorflow_object_detection_API\models-master\research\object_detection\traffic_lights\Images/")  # 存放图片的文件目录
path = os.path.join(r"D:\pycharm_community\tensorflow_object_detection_API\models-master\research\object_detection\traffic_lights\Annotations/")  # 存放生成xml的文件目录
