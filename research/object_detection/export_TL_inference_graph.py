...
flags.DEFINE_string('input_shape', None,
                    ...
                    '`[None, None, None, 3]`.')
flags.DEFINE_string('pipeline_config_path', 'D:/pycharm_community/tensorflow_object_detection_API/models_master/research/object_detection/TL_training/faster_rcnn_inception_v2_coco.config',
                    'Path to a pipeline_pb2.TrainEvalPipelineConfig config '
                    'file.')
flags.DEFINE_string('trained_checkpoint_prefix', 'D:/pycharm_community/tensorflow_object_detection_API/models_master/research/object_detection/TL_model/model.ckpt-1649',
                    'Path to trained checkpoint, typically of the form '
                    'path/to/model.ckpt')
flags.DEFINE_string('output_directory', 'D:/pycharm_community/tensorflow_object_detection_API/models_master/research/object_detection/TL_inference_graph', 'Path to write outputs.')
